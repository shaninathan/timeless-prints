...
const Checkout = () => {
  ...
  useEffect(() => {
    const handleNavigation = (target) => {
      // במקום לבדוק href, נשתמש ב-useNavigate
      if (target && target.getAttribute('data-to')) {
  ...
  return (
    <CheckoutContainer maxWidth="lg">
      ...
      >
        <DialogTitle>עזיבת הטופס</DialogTitle>
        <DialogContent>
          <Typography>
            האם אתה בטוח שברצונך לעזוב? כל המידע שהוזן יאבד.
          </Typography>
        </DialogContent>
        <DialogActions>
          <NavigationButton onClick={handleCancelNavigation} variant="outlined">
            ביטול
          </NavigationButton>
          <NavigationButton onClick={handleConfirmNavigation} variant="contained">
            עזוב
          </NavigationButton>
        </DialogActions>
      </ExitDialog>
